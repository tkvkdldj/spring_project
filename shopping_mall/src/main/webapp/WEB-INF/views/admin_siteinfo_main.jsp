...
<div class="btn_div">
    ...
    <button type="button" class="sub_btn2" title="저장 취소" id="cancel_save">저장 취소</button>
</div>
<section></section>
<section></section>
</main>
...
<script type="module">
import {save_values, shopping_set, print_data} from "./js/admin_siteinfo_main.js?v=6"
...
document.querySelector("#cancel_save").addEventListener("click", function(){
